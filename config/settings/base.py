...
JAZZMIN_SETTINGS = {
    ...
    'topmenu_links': [
        ...
        {'name': 'Запросы', 'url': 'admin:cart_stainhelprequest_changelist', 'permissions': ['cart.view_stainhelprequest']},
    ],
    'usermenu_links': [
        {'name': 'Открыть сайт', 'url': '/', 'new_window': True},
    ],
    ...
    'order_with_respect_to': [
        ...
        'cart',
        'cart.Order',
        'cart.StainHelpRequest',
        'cart.Favorite',
        'analytics',
        'analytics.SiteStatistics',
        'analytics.SearchStatistics',
        'core',
        'core.SiteSettings',
        'core.City',
        'auth',
    ...
    'icons': {
        ...
        'cart.StainHelpRequest': 'fas fa-comment-dots',
        'cart.Favorite': 'fas fa-heart',
        'core.City': 'fas fa-map-marker-alt',
        'core.SiteSettings': 'fas fa-cog',
        'analytics': 'fas fa-chart-line',
        'analytics.SiteStatistics': 'fas fa-chart-area',
        'analytics.SearchStatistics': 'fas fa-search',
    },
    'default_icon_parents': 'fas fa-chevron-circle-right',
    'default_icon_children': 'fas fa-circle',
    'related_modal_active': True,
    'custom_css': 'admin/css/jazzmin_theme.css',
    'custom_js': 'admin/js/jazzmin_theme.js',
